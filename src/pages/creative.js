...
const Creative = ({ data }) => {
  ...
  return (
    <Layout
      headerData={{
        title: intl.formatMessage({ id: "navcreative" }),
    ...
    >
      <Capability
        ...
        content={
          <>
            <h2>{intl.formatMessage({ id: "VideoHeader" })}</h2>
            <p>
      ...
      <Capability
        ...
        content={
          <>
            <h2>{intl.formatMessage({ id: "WebsitesHeader" })}</h2>
            <p>
      ...
      <Capability
        ...
        content={
          <>
            <h2>{intl.formatMessage({ id: "MarketingHeader" })}</h2>
            <p>
